...
with mp_face_mesh.FaceMesh(
  ...
  while cap.isOpened():
    ...
    if not success:
      ...
      continue
    blackImg = np.zeros(np.shape(image),dtype=np.uint8)
    ...
    if results2.multi_hand_landmarks:
        ...
        for handLms in results2.multi_hand_landmarks: # working with each hand
    ...
    cv2.imshow('MediaPipe Face Mesh', cv2.flip(blackImg, 1))
